...
@DisplayName("/poll/{id} with configured public base url ending with slash")
class PollViewControllerPublicBaseUrlTrailingSlashTest {
    ...
    @Test
    @DisplayName("removes trailing slash before composing share links")
    void removesTrailingSlashBeforeComposingShareLinks() throws Exception {
        UUID pollId = UUID.fromString("00000000-0000-0000-0000-000000000027");
        String adminSecret = "AdminSecretCfgSlash";
